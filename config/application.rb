...
module MobilityExchange
  class Application < Rails::Application
    ...
    config.filter_parameters += [:code, :state, :id_token, :access_token, :client_secret, :code_verifier, :password, :password_confirmation, :otp, :token, :signature, :date_of_birth, :private_notes, :mfa_secret, :email, :phone, :address_line1]
